...
> **🚨 중요 안내: 현재 배포 서버가 종료된 상태입니다.**
> * 아래 가이드는 로컬 환경에서 **각 프로젝트를 독립적으로 실행하는 방법**을 안내합니다.
> * 그러나 **Redis, MySQL, S3, Oauth API** 등 **외부 인프라 구성이 필수적**이며, **현재 배포 서버가 종료**되어 전체 시스템을 정상적으로 연동하여 확인하는 것은 어렵습니다.
> * **전체 기능 동작 확인**은 **제공된 데모 영상**을 참고해 주시기 바랍니다.
>    > 📺 **데모 영상 링크:** [데모 영상 바로가기](https://youtu.be/Mw2rVH66TLg)
---
<br><br>
